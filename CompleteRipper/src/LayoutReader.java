...
//		}
	...
	public class getLayout extends Thread{
		...
		public void displayNumofNodes(int emulator_n)
		{
			int node=LayoutReader.this.getNodesNumber(0);	
	...
	private void getNodesbyXml(String Path,int number)
	{
		try{
			...
			int listviewnodenum=0,countlistviewnode=0;
			int maxlistviewnodenum=0,countlistviewnode2=0;
			//------------------------------------------------
				  ...
				  if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					 ...
					 //20161025 add 判斷此class 是不是listview or gridview
					   if(eElement.getAttribute("class").equals("android.widget.ListView")&&Boolean.valueOf(eElement.getAttribute("clickable")))
					   {
						  ...
						  isClickable=true;
						  listviewnodenum=listviewnode.getLength();
						  countlistviewnode=0;
					 ...
					 //line335: 20161125針對listview會發生偵測不完所產生的腳本
					   ...
					   {
						   listviewnode=eElement.getChildNodes();
						   maxlistviewnodenum=listviewnode.getLength();
...
//	}
	...
	//-----20161024 21:48 add function " getNodesNumber"-------
		public int getNodesNumber(int emulator_n)
		{
//			int i=0;
//			if(emulator_n==0)
//				i=nodes0.size();
